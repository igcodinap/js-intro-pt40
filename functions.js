...
const variableGlobal =
  "Soy una variable global, debido a que no hay corchetes alrededor de mi";
...
// incia el bloque
if (true) {
  const variableBloque =
    "Soy valida solo en el bloque, ya que me definieron con const o let, por tanto soy una variable local";
  var variableBloqueValida = "Soy valida incluso fuera del bloque";
  // bloque 2
  if (true) {
    const variableBloque2 =
      "Soy valida solo en el bloque, ya que me definieron con const o let, por tanto soy una variable local";
  }
  // fin bloque 2
}
